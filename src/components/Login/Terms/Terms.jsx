...
function Terms({ isOpen, onClose }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="lg">
      <ModalOverlay />
      <ModalContent width="80%" marginLeft="10%" bg="white">
        <ModalHeader>
          <IconButton aria-label="Close" icon={<CloseIcon />} onClick={onClose} />
        </ModalHeader>
        <ModalBody overflowY="auto" margin="5%">
          <Text>
            <h1>Terms of Engagement</h1>
            <br />
            {`Our Terms of Engagement were last updated on March 1, 2024
          ...
          <ul>
            ...
            <li>{`“Company” (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to the
              Company: ScholarshipAuditions.com`}</li>
            ...
            <li>{`“Device” means any device that can access the Service such as a computer, a cell phone or a digital
              tablet.`}</li>
            ...
            <li>{`“Service” refers to the Website: FirstChairAmeroca.com`}</li>
            <li>{`“Terms of Engagement” (also referred as "Terms") mean these Terms of Service that form the entire
              agreement between You and the Company regarding the use of the Service. This Terms of Service
              Agreement was generated by Terms Feed Terms of Service Generator.`}</li>
            <li>{`“Third-party Social Media Service” means any services or content (including data, information, products
              or services) provided by a third-party that may be displayed, included or made available by the Service.`}</li>
          ...
          <Text>
            ...
            {`These are the Terms of Engagement governing the use of this Service and the agreement that operates between You
              and the Company. These Terms of Service set out the rights and obligations of all users regarding the use of the
              Service.`}
            <br />
            <br />
            {`Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms of
              Service. These Terms of Service apply to all visitors, users and others who access or use the Service.
              By accessing or using the Service You agree to be bound by these Terms of Service. If You disagree with any part of
              these Terms of Service then You may not access the Service.
              You represent that you are the primary user if this Service.
            ...
            {`Our Service allows You to post Content. You are responsible for the Content that You post to the Service, including its
              ...
              You agree that this license includes the right for Us to make Your Content available to other users of the Service, who
              may also use Your Content subject to these Terms.`}
            <br />
            <br />
            {`You represent and warrant that: (i) the Content is Yours (You own it) or You have the right to use it and grant Us the
            ...
            {`The Company is not responsible for the content of the Service's users. You expressly understand and agree that You
              ...
              users and/or third parties on the Service, you agree to use the Service at your own risk. You understand that by using
              the Service You may be exposed to content that You may find offensive, indecent, incorrect or objectionable, and You
            ...
            {`You assign all rights, title and interest in any Feedback You provide the Company. If for any reason such assignment
              ...
              and license to use, reproduce, disclose, sub-license, distribute, modify and exploit such Feedback without restriction.`}
            <br />
            <br />
            <h5>Links to Other Websites</h5>
            {`Our Service may contain links to third-party web sites or services that are not owned or controlled by the Company.
              For the most part, likes to other websites are a part of the ScholarshipAuditions.com Company. The Company may
              send via email or traditional forms of mail advertisements to You of the products and services of
              ScholarshipAuditions.com as well as other related companies. These will often appear in the Company monthly
              newsletter.`}
            <br />
            <br />
            ...
            {`Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under
              ...
              profits, loss of data or other information, for business interruption, for personal injury, loss of privacy arising out of or
            ...
            {`The Service is provided to You "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of any
              ...
              services, operate without interruption, meet any performance or reliability standards or be error free or that any errors
              ...
              the accuracy, reliability, or currency of any information or content provided through the Service; or (iv) that the
            ...
            {`If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted
              ...
              shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall the
          ...
          <ul>
            ...
            <li>{`By sending us an email: info@FirstChairAmerica.com`}</li>
          </ul>
        </ModalBody>
      </ModalContent>
    </Modal>
